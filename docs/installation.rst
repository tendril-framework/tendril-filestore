...
``tendril-filestore`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-filestore/releases>`_.
...
``tendril-filestore``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-filestore.git
    $ cd tendril-filestore
    $ pip install -e .
